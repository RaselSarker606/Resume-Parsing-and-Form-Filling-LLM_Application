```
# 🤖 Resume Parsing & Automating Form Filling with Google Gemini AI
...
## ▶️ Usage
1. Place resume files in the `resumes/` directory.
2. Run the parsing script:
   ```bash
   python parse_resume.py
   ```
3. Review extracted data and validate results.
4. Optionally, integrate with form-filling automation.
